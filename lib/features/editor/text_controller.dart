...
/// 自定义文本选择控制器
/// 提供更丰富的文本选择操作
class EditorSelectionControls extends TextSelectionControls {
  @override
  Widget buildToolbar(
  ...
  Widget buildHandle(
    ...
    // 使用默认的手柄
    return const DefaultTextSelectionHandleWidget();
  }
      ...
      child: Row(
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () {
              delegate.copySelection(StatusBarFormat.plainText);
              delegate.hideToolbar();
            },
            tooltip: '复制',
            padding: EdgeInsets.zero,
          ...
          IconButton(
            ...
            onPressed: () {
              delegate.cutSelection(StatusBarFormat.plainText);
              delegate.hideToolbar();
            },
            tooltip: '剪切',
            padding: EdgeInsets.zero,
          ...
          IconButton(
            ...
            onPressed: () {
              delegate.pasteSelection(StatusBarFormat.plainText);
              delegate.hideToolbar();
            },
            tooltip: '粘贴',
            padding: EdgeInsets.zero,
