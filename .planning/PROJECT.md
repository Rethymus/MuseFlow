...
- [ ] 预设世界观模板库：修仙/武侠/都市/科幻/玄幻 preset world-building packs
- [ ] 故事弧可视化：剧情结构节点连线图
- [ ] 开篇引导：交互式问卷生成3种风格开篇
- [ ] 写作数据统计：字数、写作速度、AI使用率
...
- **实时协作/多人编辑** — 单人创作工具
- **故事弧可视化** — v2 scope, needs dedicated rendering library

## Context

### Current State (post v1.0)

**Shipped:** v1.0 MVP with complete capture→synthesis→editor pipeline.
**Codebase:** 111 source files (18,685 LOC), 64 test files (12,286 LOC) — Dart/Flutter.
...
**Coverage:** 47/50 requirements verified (3 pending physical Windows device testing).
