...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/re/code/MuseFlow/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=/home/re/code/MuseFlow/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=/home/re/code/MuseFlow/.claude/commands/gsd
AGENTS_DIR=/home/re/code/MuseFlow/.claude/agents
```
...
<execution_context>
Surface state file: `/home/re/code/MuseFlow/.claude/skills/.gsd-surface.json`
Install profile marker: `/home/re/code/MuseFlow/.claude/skills/.gsd-profile`
Engine module: `/home/re/code/MuseFlow/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `/home/re/code/MuseFlow/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
