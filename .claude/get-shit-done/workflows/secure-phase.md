...
```
Agent(
  prompt="Read /home/re/code/MuseFlow/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/re/code/MuseFlow/.claude/get-shit-done/templates/SECURITY.md`
