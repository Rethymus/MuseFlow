...
```bash
INIT=$(node "/home/re/code/MuseFlow/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/re/code/MuseFlow/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
