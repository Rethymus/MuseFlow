...
INSTALL_JS_GLOBAL="/home/re/code/MuseFlow/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/re/code/MuseFlow/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
