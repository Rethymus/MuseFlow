...
<required_reading>
@/home/re/code/MuseFlow/.claude/get-shit-done/references/ai-frameworks.md
@/home/re/code/MuseFlow/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/re/code/MuseFlow/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/re/code/MuseFlow/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/re/code/MuseFlow/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/re/code/MuseFlow/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/re/code/MuseFlow/.claude/agents/gsd-eval-planner.md for instructions.
