...
```bash
INIT=$(node "/home/re/code/MuseFlow/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/re/code/MuseFlow/.claude/get-shit-done/templates/spec.md.
