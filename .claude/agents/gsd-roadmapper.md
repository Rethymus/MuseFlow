...
Reference full template: `/home/re/code/MuseFlow/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/re/code/MuseFlow/.claude/get-shit-done/templates/state.md`.
