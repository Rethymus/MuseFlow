...
- **Lightweight cross-platform design**: Flutter-based and local-first. Android and Linux have local release build-smoke evidence; Windows is validated through GitHub Actions.
...
- Android / Linux local build validation, with Windows as a GitHub Actions build target
