...
## Preface: Qidian's AI Purge

On August 18, 2026, Qidian — China's largest web-fiction platform — did something that set the whole online-serial world abuzz: every novel its system judged to have used AI was stripped of its Monthly Ticket and Bestseller chart rankings. The mark is easy to spot: a normal novel with only a handful of monthly votes still shows a rank somewhere between 10,000th and 20,000th on the Monthly Ticket chart, while novels holding hundreds or even thousands of votes display nothing but a dash where the rank should be. By unofficial community tally, at least 25 AI novels with 10,000+ paying subscribers were delisted — several averaging 30,000–50,000 subscriptions and regarded as candidates for the "Twelve Heavenly Kings," the platform's annual top-author honors. Even 6 "Grandmaster"-tier authors and 1 Twelve Heavenly Kings laureate did not survive this sweep.

Among the delisted top-tier authors, the only one who responded in public explained that he had merely used AI to fix typos and grammar and to tidy paragraphs. But the example he shared told another story: word order and phrasing had been rewritten wholesale — that is less proofreading than polishing. If an entire book were revised that way, an AI verdict should hardly come as a surprise. Nor does the judgment seem hair-trigger: the platform reportedly measures the AI share of the whole work and only acts once it passes roughly one-tenth — a loose bar where misses happen and false kills barely do. After-the-fact defenses of "just fixing grammar" are best taken with a grain of salt. An ordinary author using AI is one thing; a grandmaster who stops cherishing his own plumage — and his readers — is the truly lamentable part. At least the enforcement was even-handed; thankfully, no Platinum-level author was on the list.

On the reader side, delisting cuts deeper than it looks. Losing the charts is only the first blow: it works as a de facto official label — this book used AI. Readers who would happily subscribe in ignorance mostly turn away once they know; the novels keep updating, but those who stay are largely readers who don't care whether it is AI, plus the genuinely devoted. The two charts matter enormously for discovery, and after delisting these books' daily new library adds slid from around a thousand to visible net losses. One well-known author put it bluntly, and the crude logic holds: readers never paid this price for AI-written fiction — like "freshly wok-fried" dishes cooked in a central kitchen, however tasty, they are still pre-made meals.

These voices made us re-examine what MuseFlow set out to do: give people rich in imagination but rough in prose a pair of AI wings, so the worlds in their heads can reach the page, and help working authors write faster and better. Yet the purge shows the other side of that coin — even light polishing, by popular and veteran authors alike, was punished without exception. Reader comments are blunter still: however sweet AI prose gets, it remains an empty shell that no feeling fills; it simply cannot read a character's joys and sorrows. By that logic, the moment readers hit subscribe, they are buying more than plot — they are buying a trace of human warmth between the lines. So is it true, after all, that "paying readers are buying emotional value"?

We will not draw conclusions from a single event, nor rush to take sides. This time, MuseFlow chooses to study the essence of the question from a neutral, even-handed standpoint: what role should AI actually play in creation, where the boundary lies, and what it can genuinely offer authors and readers. We believe that, in time, MuseFlow will offer its own new answer. Stay tuned.

> The event account and viewpoints above are drawn from two articles by "雾野漫游" on XIAOHEIHE: "起点斩杀AI文，竟然有6位大神作者和1位12天王作者的小说也被处理" ([original link](https://www.xiaoheihe.cn/app/bbs/link/188604679)) and "知名恋爱文作者蜜汁姬用“青楼比喻”评价AI文，真的是话糙理不糙" ([original link](https://www.xiaoheihe.cn/app/bbs/link/09687254ceb9)).
