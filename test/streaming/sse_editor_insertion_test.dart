...
void main() {
  ...
  group('SSE Editor Insertion', () {
    ...
    test('batch-inserts tokens into super_editor without jank', () async {
      ...
      final avgFrameTime = frameTimes.isNotEmpty
          ...
          : Duration.zero;
      final jankFrames = frameTimes.where((t) => t.inMilliseconds > 16).length;
      final severeJankFrames = frameTimes
          .where((t) => t.inMilliseconds > 32)
          .length;
      ...
      // ignore: avoid_print
      print(
        'Number of batches: ${(simulatedTokens.length / batchSize).ceil()}',
      );
      // ignore: avoid_print
    ...
    test('inserts large batch of tokens for performance stress test', () async {
