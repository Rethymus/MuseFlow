...
void main() {
  group('EditorChapterMemoryContextBuilder', () {
    ...
    group('chapterContextChain (LFIN-01)', () {
      ...
      test('should build chain with one previous chapter at 220 chars', () async {
        final builder = EditorChapterMemoryContextBuilder(
          chapterRepository: repository,
        );
        await repository.add(
      ...
      test('should build chain with decreasing detail for 3 previous chapters',
          () async {
        final builder = EditorChapterMemoryContextBuilder(
          chapterRepository: repository,
        );
      ...
      test('should truncate chapter text at decreasing limits', () async {
        ...
        await repository.add(
          _chapter(id: 'c1', sortOrder: 1, text: longText),
        );
        ...
        final summaryPart = summaryLine.replaceFirst(
          RegExp(r'^紧邻前章摘要：'),
          '',
        );
      ...
      test('should skip empty chapters in the chain', () async {
        ...
        await repository.add(
          _chapter(id: 'c1', sortOrder: 1, text: ''),
        );
        await repository.add(
          _chapter(id: 'c2', sortOrder: 2, text: '有内容的章节。'),
        );
