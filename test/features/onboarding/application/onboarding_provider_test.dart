  ...
  group('onboardingProgressProvider registration', () {
    test(
      ...
      () async {
        ...
        final onboardingRepo = await container.read(
          onboardingProgressProvider.future,
        );
        ...
        expect(
          onboardingRepo.getProgress(),
          equals(OnboardingProgress.initial()),
        );
    ...
    test(
      'should depend on settingsRepositoryProvider for box access',
      () async {
