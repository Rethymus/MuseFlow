  ...
  group('OperationTypePieChart', () {
    testWidgets('renders empty state text when no records provided', (
      ...
      await tester.pumpWidget(
        const MaterialApp(
          home: Scaffold(body: OperationTypePieChart(records: [])),
        ),
      );
    ...
    testWidgets(
      'groups records by AuditOperationType.group into 4 pie sections',
      (tester) async {
        ...
        await tester.pumpWidget(
          MaterialApp(
            home: Scaffold(body: OperationTypePieChart(records: records)),
          ),
        );
