...
class GoFixtures {
  ...
  static CharacterCard protagonist() {
    return CharacterCard(
      ...
      backstory: '二十二岁刚毕业的迷茫青年。童年曾学棋，十二岁一场关键对局自认下出"毁棋的俗手"后弃棋，从此认定自己平庸怯懦。仲夏躲雨误入半目棋社，被怪老头一句话钉住，重新识棋、识人、识己',
  ...
  static CharacterCard master() {
    return CharacterCard(
      ...
      backstory: '七十岁上下，瘦，左小指少一节，半目棋社老板。街坊当他落魄棋客，实为三十年前诸多妙手真正的源头。他藏起会反噬好友的妙手、甘当一辈子被讥为"俗手"的陪练，是全书反转所在',
      createdAt: _fixedDate,
    );
  }
  ...
  static CharacterCard xiaoman() {
    return CharacterCard(
      ...
      backstory: '陆衡童年邻居、故人之女，在某大公司扶摇直上。险走一步"漂亮捷径"（看似妙手、实为俗手），被陆衡以笨拙的本手拦下，后凭扎实补漏站稳脚跟。其捷径的延迟反噬在第60章兑现',
      createdAt: _fixedDate,
    );
  }
  ...
  static CharacterCard jiangchao() {
    return CharacterCard(
      ...
      backstory: '陆衡童年宿敌，十二岁击败陆衡致其弃棋。后成名满天下的国手，但其惊艳天下的"神之一手"实为十二岁时从半目棋社偷看的残局思路。偷来的妙手没有本手的根，终被反噬',
      createdAt: _fixedDate,
    );
  }
  ...
  static List<SkillDocument> skillRules() {
    return [
      ...
      SkillDocument(
        ...
        content: '本手=合乎棋理的正规下法(基础)；妙手=出人意料的精妙之手(创造)；俗手=貌似合理而全局受损的劣着。辩证：俗手亦妙、妙手亦俗、本手或妙或俗，真假互为表里',
        sections: SkillSections(
          rules: '围棋术语(定式/急所/棋筋/厚势/先手/弃子/复盘/愚形/半目/盘外招等)须用得准确；不可把俗手写成妙手或反之而无辩证铺垫',
      ...
      SkillDocument(
        ...
        sections: SkillSections(
          ...
          taboos: '禁止修仙、法术、灵气、境界、飞升等设定；禁止真正的"系统面板/穿越/异能"——师傅口中的"系统"是隐喻与梗，非真实游戏系统',
        ),
        isActive: true,
        createdAt: _fixedDate,
      ),
